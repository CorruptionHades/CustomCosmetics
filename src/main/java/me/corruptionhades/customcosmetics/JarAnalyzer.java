...
public class JarAnalyzer extends ClassVisitor {
    ...
    public static void main(String[] args) throws IOException {
        scanJar(new File("/home/mitarbeiter/IdeaProjects/CustomCosmetics/.gradle/loom-cache/minecraftMaven/net/minecraft/minecraft-merged-4c1b918aa2/1.21.3-net.fabricmc.yarn.1_21_3.1.21.3+build.2-v2/minecraft-merged-4c1b918aa2-1.21.3-net.fabricmc.yarn.1_21_3.1.21.3+build.2-v2.jar"));
    ...
    private static class MethodScannerVisitor extends MethodVisitor {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String descriptor, boolean isInterface) {
            ...
            if (owner.equals("net/minecraft/client/gl/VertexBuffer") && name.equals("draw")) {
